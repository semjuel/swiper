...
class SwiperForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    // Only integers.
      ...
      '#description' => $this->t('Margin between carousel items. (NB: the margin must be set in your CSS styles. This property merely informs Swiper of the margin.)'),
    ...
    $form['nav_controls']['thumbCaptions'] = [
      ...
      '#description' => $this->t('<em>Requires Swiper Library 2.2+</em>. After selecting this captions will be added to thumbnails and removed from the main slide.'),
    ...
    $form['nav_controls']['thumbCaptionsBoth'] = [
      ...
      '#description' => $this->t('<em>Requires Swiper Library 2.2+</em>. Display captions in the thumbnail as well as in the slider.'),
    ...
    $form['advanced']['pausePlay'] = [
      ...
      '#description' => $this->t('Have Swiper add an element indicating the current state of the slideshow (i.e. "pause" or "play").'),
    ...
    $form['advanced']['controlsContainer'] = [
      ...
      '#description' => $this->t('Declare which container the navigation elements should be appended too. Default container is the swiper element. Example use would be ".swiper-container", "#container", etc. If the given element is not found, the default action will be taken.'),
